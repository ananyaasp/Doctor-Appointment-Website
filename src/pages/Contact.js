  ...
  return (
    ...
    <div style={{ marginTop: '20px' }}>
        ...
        <p>
          ...
          {/* rel="noopener noreferrer" is a common practice for secure external links that open in a new tab, 
          particularly when using target="_blank". It prevents security issues and enhances user privacy. */}
        </p>
      </div>
